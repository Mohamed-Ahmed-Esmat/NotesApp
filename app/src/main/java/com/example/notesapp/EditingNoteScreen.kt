...
fun EditingNoteScreen(
    ...
    Column(
        ...
        Row(
            ...
            OutlinedButton(
                onClick = {
                    viewModel.upsertNote(Note(id, noteDetails = details, noteTitle = title))
            ...
            OutlinedButton(
                onClick = {
                    viewModel.deleteNote(Note(id, details, title))
                    navController.popBackStack()
                },
                modifier = modifier
                    .weight(1f)
...
private fun EditingNoteScreenPreview() {
    EditingNoteScreen(id = 2, noteDetails = "test details", navController = rememberNavController(), noteTitle = "test title")
}